          ...
          >
            ...
            >
              ...
              <span
                ...
                id='error-userEmail'
              >
                {email.isDirty && email.errors.message && (
                  <ErrorText type='auth'> {email.errors.message}</ErrorText>
                )}
              </span>
            </label>
            <label
            ...
            >
              ...
              <span className='form__error ' id='error-userPassword'>
                {password.isDirty && password.errors.message && (
                  <ErrorText type='auth'> {password.errors.message}</ErrorText>
                )}
              </span>
            </label>
          </fieldset>
